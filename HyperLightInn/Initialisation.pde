...
void setupLists(){
  //(1)Catalogue setup --> DON'T include texture variations
  tileCatalogueNames.clear();
  tileCatalogueIcons.clear();
  tileCatalogueNames.add("Wall");tileCatalogueNames.add("Barrel");tileCatalogueNames.add("Door");tileCatalogueNames.add("Table");tileCatalogueNames.add("Chair");tileCatalogueNames.add("Counter");tileCatalogueNames.add("MiscMachine");tileCatalogueNames.add("Tree");tileCatalogueNames.add("Water");tileCatalogueNames.add("lrgTree");tileCatalogueNames.add("Pump");tileCatalogueNames.add("Vat");tileCatalogueNames.add("Machinery");tileCatalogueNames.add("Field");tileCatalogueNames.add("##Invis##");tileCatalogueNames.add("Open fire");tileCatalogueNames.add("##Outpost##");tileCatalogueNames.add("##Port##");
  tileCatalogueIcons.add(magicWallMiddle);tileCatalogueIcons.add(magicBarrel);tileCatalogueIcons.add(magicDoor);tileCatalogueIcons.add(magicTable);tileCatalogueIcons.add(magicStool);tileCatalogueIcons.add(magicCounterMiddle);tileCatalogueIcons.add(test1);tileCatalogueIcons.add(tree);tileCatalogueIcons.add(waterCenter);tileCatalogueIcons.add(lrgTree);tileCatalogueIcons.add(pump);tileCatalogueIcons.add(vat);tileCatalogueIcons.add(machinery);tileCatalogueIcons.add(field);tileCatalogueIcons.add(test2);tileCatalogueIcons.add(fireContained);tileCatalogueIcons.add(tradingOutpost);tileCatalogueIcons.add(port);
  
  floorCatalogueNames.clear();
  floorCatalogueIcons.clear();
  floorCatalogueNames.add("GrassPlain");floorCatalogueNames.add("MagicPlain");
  floorCatalogueIcons.add(naturalFloorPlain);floorCatalogueIcons.add(magicFloorPlain);
  
  itemCatalogueNames.clear();
  itemCatalogueIcons.clear();
  itemCatalogueNames.add("Sticks");itemCatalogueNames.add("Water bucket");itemCatalogueNames.add("Spade");itemCatalogueNames.add("Seeds");itemCatalogueNames.add("Fertiliser");itemCatalogueNames.add("Manual");
  itemCatalogueIcons.add(sticks);itemCatalogueIcons.add(waterBucket);itemCatalogueIcons.add(spade);itemCatalogueIcons.add(seeds);itemCatalogueIcons.add(fertiliser);itemCatalogueIcons.add(userManual);
  

  //(2)Pie selector setup
  pieSelected.clear();
  pieSelected.add( new ArrayList<Integer>() );  //Tiles pie selector
  pieSelected.add( new ArrayList<Integer>() );  //Floor pie selector
  pieSelected.get(0).add(0);  //Initial tiles to help new players start
  pieSelected.get(0).add(1);  //
  pieSelected.get(0).add(2);  //
  pieSelected.get(1).add(0);  //
  pieSelected.get(1).add(1);  //
...
void loadTextures(){
  ...
  tradingOutpostMenu = loadImage("tradingOutpostMenu.png");
  ...
  waterBucket = loadImage("waterBucket.png");
  spade       = loadImage("spade.png");
  seeds       = loadImage("seeds.png");
  fertiliser  = loadImage("fertiliser.png");
  userManual  = loadImage("userManual.png");
